...
Intelligence Agent State - handles brand monitoring, entity tracking
"""
import operator 
...
class IntelligenceAgentState(TypedDict, total=False):
    ...
    Monitors brand mentions, competitive intelligence, entity tracking.
    This maps to the "Market Intelligence Agent" in your report.
    """
